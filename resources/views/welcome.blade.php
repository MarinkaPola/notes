<!DOCTYPE html>
    ...
    <body class="antialiased">
        <div style="background-color: #b7e9ff; position: fixed; width: 100%; margin-bottom: 20px">
            <div style="font-size: 20px; padding-left: 20px; padding-top: 15px; height:80px" >MY PROJECT NOTES</div>
            @if (Route::has('login'))
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        <a  href="/redirect/google">
                            <i class="fa fa-google" aria-hidden="true" style="font-size: 30px; color: crimson; margin-left: 10px"></i>
                        </a>
                        <a   href="/redirect/facebook">
                            <i class="fa fa-facebook-square" aria-hidden="true" style="font-size: 30px; color: #416adc; margin-left: 10px"></i>
                        </a>
                    @endauth
                </div>
            @endif
                            ...
                            <div class="card-body">
                                <article style="margin: 15px">
                                    ...
                                    <button type="button" class="btn btn-info">
                                        <a href="/notes/{{$note->uuid}}">details</a>
                                    </button>
                                </article>
                            </div>
                            @if($note->user)
